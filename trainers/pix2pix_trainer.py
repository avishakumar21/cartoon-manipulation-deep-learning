...
class Pix2PixTrainer():
    ...
    def run_generator_one_step(self, data, i, is_real_im=True):
        self.optimizer_G.zero_grad()
        g_losses, inputs, generated = self.pix2pix_model(data, mode='generator', is_real_im=is_real_im)
        if len(g_losses.keys())>0:
